...
public class Peer1 {
	...
	static String root = Peer1.class.getResource(".").getPath();
...
//			peerC = (String) c.dataInputStream.readObject();
		...
		System.out.println("Peer 1 , [CHUNKS_TOTAL] - " + chunkFiles_total);
		while(true)
		{
			System.out.println("Peer 1 , [CHUNKS TO BE RECEIVED] - "+c.chunks_Set);			
	...
	public void peer_ServerConn(int port) {
		try {
			...
			System.out.println(this.getClass().getName() + " Peer 1 [ACCEPT]");
