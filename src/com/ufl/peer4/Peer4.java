...
public class Peer4 {
	...
	static String root = Peer4.class.getResource(".").getPath();
...
//			peerC = (String) c.dataInputStream.readObject();
			...
			System.out.println("Peer 4 , [CHUNKS_TOTAL] - " + chunkFiles_total);
			while(true)
			{
				System.out.println("Peer 4 , [CHUNKS TO BE RECEIVED] - "+c.chunks_Set);
	...
	public void peer_ServerConn(int port) {
		try {
			...
			System.out.println(this.getClass().getName() + " Peer 4 [ACCEPT]");
